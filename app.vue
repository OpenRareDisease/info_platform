<template>
  <div style="padding: 20px; font-family: system-ui, sans-serif; max-width: 800px; margin: 0 auto;">
    ...
    <!-- Add Note Form -->
    <div style="margin-bottom: 30px; padding: 20px; border: 2px solid #4CAF50; border-radius: 8px; background: #f0f8f0;">
      ...
      <form @submit.prevent="submitNote">
        <input 
          ...
          style="width: 100%; padding: 12px; font-size: 16px; border: 1px solid #ddd; border-radius: 4px; margin-bottom: 10px;"
          :disabled="submitting"
        />
        <button 
          type="submit"
          :disabled="!newMessage.trim() || submitting"
          style="padding: 12px 24px; font-size: 16px; background: #4CAF50; color: white; border: none; border-radius: 4px; cursor: pointer;"
      ...
      <div v-if="data?.notes && data.notes.length > 0">
        <ul style="list-style: none; padding: 0;">
          <li 
            ...
            :key="note.id"
            style="padding: 15px; margin: 10px 0; border: 1px solid #ddd; border-radius: 8px; background: #f9f9f9;"
          >
